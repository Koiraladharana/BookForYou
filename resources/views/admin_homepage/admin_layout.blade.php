...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="{{ route('admindas') }}"><i class="fas fa-tachometer-alt me-2"></i>Dashboard</a>
        <a href="{{ route('showBooks') }}"><i class="fas fa-book me-2"></i>Show Books</a>
        <a href="{{ route('showUsers') }}"><i class="fas fa-users me-2"></i>Show Users</a>
        <a href="{{ route('showFraudReports') }}"><i class="fas fa-exclamation-triangle me-2"></i>Show User Reports</a>
    </div>
