        ...
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body p-4">
                    ...
                    <a href="<?php echo e(route('messages.create', ['recipientId' => $book->user_id, 'bookId' => $book->id])); ?>" class="btn btn-primary rounded-pill me-2"><i class="fas fa-envelope me-2"></i> Send Message</a>
